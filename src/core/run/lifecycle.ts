...
const TRANSITIONS: Record<RunStatus, readonly RunStatus[]> = {
  ...
  RUNNING: ["PAUSED", "WAITING_FOR_NAMING", "WAITING_FOR_POLICY_AUTHORITY", "WAITING_FOR_DEROGATORY_DECISIONS", "COMPLETE", "FAILED"],
  PAUSED: ["RUNNING", "FAILED"],
  WAITING_FOR_NAMING: ["READY", "FAILED"],
  WAITING_FOR_POLICY_AUTHORITY: ["RUNNING", "FAILED"],
  WAITING_FOR_DEROGATORY_DECISIONS: ["RUNNING", "FAILED"],
  FAILED: [],
  COMPLETE: [],
};
