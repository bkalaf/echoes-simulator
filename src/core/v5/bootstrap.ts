...
export function bootstrapWorldV5(input: BootstrapWorldInput): { state: WorldStateV5; events: CausalEventV5[]; namingRequests: NamingRequestV5[] } {
  ...
  let state: WorldStateV5 = { schemaVersion: "echoes-world-state-v5", worldKey: input.worldKey, year: 0, cohorts: [], settlements, states, families: [], politicalPeople: [], personRelations: [], organizations: [], institutions: [], offices: [], officeTerms: [], ownershipStakes: [], familyRelations: [], borderRelations: [], timedConditions: [], activeConflicts: [], worldRoutes: [], resourceAuthorityStatus: { status: "RESOURCE_AUTHORITY_REQUIRED", authorityRevisionId: null, contentSha256: null }, resourceNodes: [], worldResourceStates: [], industries: [], securityForces: [], diplomaticRelations: [], diplomaticAgreements: [], conflictEpisodes: [], settlementControlTerms: [], populationSlices: [], derogatoryTargetSelections: [], localAtrocityResponses: [], forcedDisplacements: [], enclaves: [] };
